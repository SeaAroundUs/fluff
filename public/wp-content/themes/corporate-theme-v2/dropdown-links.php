...
function _walk_bookmarks2($bookmarks, $args = '' ) {
	$defaults = array(
	...
	foreach ( (array) $bookmarks as $bookmark ) {
		...
		$output .= ' value="' . $the_link . '"' . $rel . $title . $target. '>';
...
function wp_list_bookmarks_dropdown($args = '') {
	$defaults = array(
	...
	if ( $categorize ) {
		...
		foreach ( (array) $cats as $cat ) {
			...
			$output .= _walk_bookmarks2($bookmarks, $r);
			$output .= "\n\t</ul>\n$category_after\n";
		}
	} else {
