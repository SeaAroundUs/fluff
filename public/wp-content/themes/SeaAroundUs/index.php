...
<?php 
	if(count($links)): ?>
	 ...
	 <ul class="headlines">
	  ...
	  <?php echo join("\n", array_slice($links,0,5)); ?> </ul>

	<br/><a href="index.php/category/new-notable/">See all posts</a>
...
<h5><a href="<?php echo get_category_link($category);?>"><?php echo get_cat_name($category); ?>&raquo;</a></h5>

        <ul>
        <?php 

	$my_query = new WP_Query('showposts=5&category_name='. get_cat_name($category)); 
